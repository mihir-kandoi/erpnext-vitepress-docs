...
ERPNext provides you default tax template for vat(5%, zero, exempted) and excise(50%, 100%). You can create your own [tax template](/erpnext/setting-up-taxes).

![Default Tax Template](/files/uae-tax-templates.png)

### 3. Making VAT-ready invoices

If you have set up the TRN of your Customers and Suppliers, and your tax template, you are ready to go for making VAT-ready invoices!
