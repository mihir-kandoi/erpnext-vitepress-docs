...
- **Entry Type**: You can select from the [entry types available in Journal Entry](/erpnext/journal-entry) here. Default value is [Journal Entry](/erpnext/journal-entry).
- There are 3 special 'Entry Types' in this:
- [Opening Entry](/erpnext/journal-entry): This will get all the accounts and load them into the "Accounting Entries" table. To learn more visit [Opening Balance](/erpnext/opening-balance) page.
- [Bank Entry](/erpnext/journal-entry): This will get and load the default Bank Account if set.
- [Cash Entry](/erpnext/journal-entry): This will get and load the default Cash Account if set.
...
3.  Save and go to [Journal Entry](/erpnext/journal-entry) and click on new.
