...
![E Commerce Settings](/files/e_commerce_settings_overview.png) _E Commerce Settings_
...
![Filters and Categories](/files/filters_and_categories.png) _Filters and Categories_
...
2. **Enable Reviews and Ratings**: Add the provision for **customers** to leave reviews and ratings against Website Items.
