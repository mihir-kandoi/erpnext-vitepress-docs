...
![](/files/kh7A7Gv.png)  
**Answer:** Since [Perpetual inventory](/erpnext/perpetual-inventory) is enabled in the your Company master, it requires the syncing of Stock Ledger and Stock Accounts (ledger) balance. The error message indicates that there is a mismatch in the stock and accounts balance due to previous entries  
