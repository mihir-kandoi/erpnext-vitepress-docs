...
1. For opting in all Customers by default, tick on 'Auto Opt In (For all customers)'. Otherwise, the program needs to be assigned from the [Customer master](/erpnext/loyalty-program).
1. In the table, enter:
1. **Tier name**: To be assigned to a Customer based on his eligibility.
1. **Collection Factor**: How much amount needs to be spent to gain 1 Loyalty Point in ERPNext.
...
1. [Sales Invoice](/erpnext/sales-invoice)
1. [Customer](/erpnext/customer)
1. [Customer Group](/erpnext/customer-group)
