...
The system, by design, doesn't allow you to activate these options once stock transactions have been made.![](/files/a0VHlSB.png)You can read more about why the same is disabled [here](/erpnext/maintain-stock-field-frozen-in-item-master).  
