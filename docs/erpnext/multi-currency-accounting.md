...
1. **NOTE**: Starting from ERPNext version 13.10.0, Frankfurter is replaced by a new service called [exchangerate.host](https://exchangerate.host).
...
1. [Currency Exchange](/erpnext/currency-exchange)
1. [Currency](/erpnext/currency)
