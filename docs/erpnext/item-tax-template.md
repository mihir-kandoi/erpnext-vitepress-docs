...
1. [Item](/erpnext/item)
1. Enable 'Automatically add Taxes and Charges from Item Tax Template' in [Account Settings](/erpnext/accounts-settings)
...
![Select Item Tax Template](/files/select-item-tax-template.png)
...
- If there is more than one valid tax template, then the first valid tax template from Item Tax table will be fetched.
- If there are no valid tax templates, then the first tax template with no 'Valid From' date in the Item Tax table will be fetched.
