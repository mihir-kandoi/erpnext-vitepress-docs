...
[Payment Reconciliation](/erpnext/payment-reconciliation) and its extension [Semi-Auto Payment Reconciliation](/erpnext/semi-auto-payment-reconciliation) tools uses Payment Ledger to calculate outstanding Invoices. Reconciliation process only updates Payment Ledger.
