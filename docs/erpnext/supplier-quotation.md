...
The supplier can submit you a quotation himself via ERPNext. To know more about this, see section visit the [Request for Quotation page](/erpnext/request-for-quotation).
...
usually send out a [Request for Quotation](/erpnext/request-for-quotation) to various Suppliers. In
