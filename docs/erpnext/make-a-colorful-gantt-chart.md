...
1. Go to [Customize Form](/erpnext/customize-form) in the system and select _Task_ in _Enter Form Type_ option. Alternatively, you can reach this screen by going to **Menu > Customize** from the Task list or form.

![customize-form](/files/project-gantt-customize-form-1.gif)

1. Add a new field in the doctype of fieldtype color.
1. Check _In List View_ option.
