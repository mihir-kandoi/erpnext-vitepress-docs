---
title: "Daily Depreciation Calculation"
---

# Daily Depreciation Calculation

In the **[Accounts Settings](/erpnext/accounts-settings)** of ERPNext, there is a check box that allows users to enable "Calculate daily depreciation using total days in depreciation period" checkbox.
...
![](/files/Screenshot 2026-02-20 at 1.34.05 AM.png)
...
- [Asset Depreciation](/erpnext/asset-depreciation)
- [Asset Reports](/erpnext/asset-reports)
