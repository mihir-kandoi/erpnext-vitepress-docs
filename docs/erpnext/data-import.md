...
4. _After you choose the export type, every field appears in the list. **Mandatory** fields show a red _ next to the name. **Conditional** fields (for example **Depends On** or autoname-related) show a small **info** icon—point at it to read the note.\*
...
![](/files/Screen Recording 2026-02-18 at 9.43.24 PM.mov)
