...
1\. Open Customize Form using awesome search bar or via Menu options of any DocType. This will open a screen where you can view all the fields that comprise this DocType.
...
To learn more about customisations in ERPNext, check out this [link](/erpnext/customize-form)
