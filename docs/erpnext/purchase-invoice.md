...
![](/files/Screenshot 2026-01-19 at 12.37.15 PM.png)
...
![](/files/Screenshot 2026-01-19 at 12.38.23 PM.png)
...
![](/files/Screenshot 2026-01-19 at 12.39.12 PM.png)

This is invoice level holding, Suppliers can be put on hold. [Learn more here](/erpnext/supplier).
...
![](/files/Screenshot 2026-01-19 at 12.39.55 PM.png)
...
![](/files/Screenshot 2026-01-19 at 12.40.47 PM.png)
...
![](/files/Screenshot 2026-01-19 at 12.42.03 PM.png)
...
![](/files/Screenshot 2026-01-19 at 12.43.59 PM.png)

To know more, visit the [Payment Terms](/erpnext/payment-terms) page.

### 3.12 Write Off

Write off happens when the Customer pays an amount less than the invoice amount. This may be a small difference like 0.50. Over several orders, this might add up to a big number. For accounting accuracy, this difference amount is 'written off'. To know more, visit the [Payment Terms](/erpnext/payment-entry) page.
...
![](/files/Screenshot 2026-01-19 at 12.45.03 PM.png)
...
![](/files/Screenshot 2026-01-19 at 12.45.54 PM.png)
...
![](/files/Screenshot 2026-01-19 at 12.47.43 PM.png)
...
![](https://docs.erpnext.com/files/enable-provisional-accounting.png)

1. Make a Purchase Receipt for a non-stock item

![](https://docs.erpnext.com/files/pa-purchase-receipt.png)

Accounting entries against the Purchase Receipt will be as follows

![](https://docs.erpnext.com/files/pa-accounting-entry-pr.png)
...
![](https://docs.erpnext.com/files/pa-account-entries-pi.png)

On posting a purchase invoice accounting entries against the purchase receipt will be reversed

![](https://docs.erpnext.com/files/pa-accounting-entries-pr-reversed.png)
