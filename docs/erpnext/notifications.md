...
2. Select the Document Type you want to watch changes on. From Version 16, You can also select child Document Types if Send Alert On is set to *Days Before*or _Days After_.
...
![Setting Condition](/files/notification screenshotb9a4a2.jpg)
