...
6. **Periodicity**: Forecasting data can be viewed on a monthly, quarterly, half-yearly, or yearly basis. Old forecast data cannot be displayed for monthly periods for a better view.
