...
You can also fetch the parameters using a [Quality Feedback Template](/erpnext/quality-feedback-template). The templates store preset information for you to select in the Quality Feedback.
