...
5. If the selected BOM has Operations mentioned in it, the system will fetch all Operations from BOM, these values can be changed. Refer [section 3.2](/erpnext/work-order) to know more.
...
A Work Order can also be directly created from a [Sales Order](/erpnext/sales-order).
...
The Source Warehouse can be changed for the raw material items used here. The default Warehouse can be set at the Item level in the [Item](/erpnext/item) master or globally in [Stock Settings](/erpnext/stock-settings).
...
- In the Operations table: The Workstations where the Operations will be performed ![PO Operations](/files/PO-operations.png)
...
### 4.2 Transfer Additional Materials
