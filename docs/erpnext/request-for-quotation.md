...
**A Request for Quotation is a document that an organization sends to one or more suppliers requesting quotations for items.**
...
![Supplier Quotation from RFQ](/files/make-supplier-quotation-from-rfq.png) 2. Select the Supplier, click on the supplier again. In this page, click on the + next to 'Supplier Quotation'. A new Supplier Quotation page will open, where the user must enter the quantity and rate, and then submit it.
