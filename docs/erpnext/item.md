...
- **Allowance Percentage**: This option will be available only when you create and save the item. This is the percent by which you will be allowed to over-bill or over-deliver this Item. If not set, it will select from [Stock Settings](/erpnext/stock-settings).
...
- **Brand**: If you have more than one brand, save them under Selling > Brand and preselect them while filling a New Item.
...
The Customer may identify an Item with a different Item Code. this is Similar to [Supplier Code](/erpnext/item).
...
![](/files/Screenshot 2026-03-04 at 4.23.37 PM.png)
...
![](/files/Screenshot 2026-03-04 at 4.23.45 PM.png)
