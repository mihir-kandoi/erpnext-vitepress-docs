...
The tax rates you define in the template will be the standard tax rate for all Items. If there are Items that are supposed to have different rates, you can override the standard tax rate by setting an Item Tax Template to the Item or Item Group.

### 3. Related Topics

1. [Sales Order](/erpnext/sales-order)
1. [Selling Settings](/erpnext/selling-settings)
