...
If you want to prohibit an ERPNext user from using the system then you can follow the steps below. This will be useful when your employees resign or in case you want to ban certain users from accessing the system.
