...
Before creating an Email Account, you need an [Email Domain](/erpnext/email-domain). However, you can skip creating an Email Domain if you're using one of the services listed below, then create [here](/erpnext/email-inbox) for set up
...
2. Enter the email address with the domain. [Domains](/erpnext/email-domain) need to be created in order to create an email account. You don't need to create a domain if you're syncing an email from certain providers as listed [here](/erpnext/email-inbox).
