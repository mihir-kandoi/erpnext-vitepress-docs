...
We used Temporary Opening Account for updating opening balance. After updating the balance in all Balance Sheet accounts, there is still some balance in Temporary Account? What is the cause of this balance, and how can you make the balance in this account zero?
