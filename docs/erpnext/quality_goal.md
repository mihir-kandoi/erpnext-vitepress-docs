...
If you set the frequency, a [Quality Review](/erpnext/quality_review) document will be created automatically periodically where you can maintain the actual performance measures.

To access the Quality Goal list, go to:

> Home > Quality > Quality Goal

![](/files/Screenshot 2026-01-23 at 12.16.34 AM.png)

## 1. How to Create a Quality Goal

1. Go to the Quality Goal list, click on New.
2. Enter a name for the goal.
3. Select a [Quality Procedure](/erpnext/quality_procedure) to be followed to achieve the Goal.
