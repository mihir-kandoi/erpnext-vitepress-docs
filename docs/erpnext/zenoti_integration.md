...
2. Items*(at least those having stock impact)* have to be created. Data import can be used for this.
...
3. **Sync Interval:** Duration in hours between each syncing. Following options are available _(1, 3, 6, 12, 24)_
