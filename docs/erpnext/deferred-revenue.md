...
Internet and broadcasting service providers offer subscription plans on a quarterly or yearly basis. They take complete payment in advance from the Customer for a couple of months, but book income on monthly basis in their book of accounts. This is Deferred Revenue for the Supplier and [Deferred Expense](/erpnext/deferred-expense) for the Customer. The following is how they should configure Deferred Revenue accounting in ERPNext to automate the process.
...
[Embedded video](https://www.youtube.com/embed/j6mx-EHU4aY)
