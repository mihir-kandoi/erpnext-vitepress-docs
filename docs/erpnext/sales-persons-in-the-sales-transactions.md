...
In ERPNext, Sales Person master is maintained in [tree structure](/erpnext/managing-tree-structure-masters). Sales Person is selectable in all the sales transactions.
