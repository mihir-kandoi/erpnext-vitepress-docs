...
- Once Google Contacts Integration is successful, all the contacts created in ERPNext will be synced if `Push to Google Contacts` is checked.
...
- Once Google Contacts Integration is successful, all the contacts in Google Contacts will be synced if `Pull from Google Contacts` is checked.
