...
1. Check the _Enable Discount Accounting_ box in the _Accounts Settings_ page.
...
- _For Sales Invoices:_
  ![Discount Accounting for Sales Invoices](/files/Discount Accounting for Sales Invoices.png)

- _For Purchase Invoices:_
  ![Discount Accounting for Purchase Invoices](/files/Discount Accounting for Purchase Invoices.png)

### Default Discount Account

Additionally, you could enter a Default Discount Account for an Item, which will be fetched automatically while creating the Invoice. The visibility for this field is also dependent on the Enable Discount Accounting checkbox in Accounts Settings.
