...
Transactions like sales orders/invoices have a table detailing items bought or sold. It has multiple columns like Item Name, Description, UoM, Rate Amount, etc. If there are many columns in the Item table, then the Print Format looks a bit cluttered. You can improve the view of the table by enabling Compact Item Print.
...
1. [Custom Translations](/erpnext/custom-translations)
