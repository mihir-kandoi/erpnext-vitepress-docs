...
In ERPNext, you can create Material Transfer entry from [Stock Entry](/erpnext/stock-entry) document. However, there are some scenarios in the Material Transfer where it needs to be presented as a Delivery Note and Purchase Receipt.
