...
Once an Email Account is created for a User, select that Email Account in the User. This will ensure that emails pulled from the selected Email ID will be accessible only to this User in your ERPNext account.
...
If you have correctly configured Email Inbox as instructed above, then when a User logs in, the Email Inbox icon will be visible. This will navigate the user to Email Inbox view within the ERPNext account. All the Emails received on that email will be fetched and listed in the Email Inbox view. The User will be able to open emails and perform various actions on them.
