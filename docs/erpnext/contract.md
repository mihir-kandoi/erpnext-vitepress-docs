...
### 2.4 Fulfillment Details

If the Contract requires some fulfillment from the Supplier's (your) end, their details can be recorded in the Fulfillment Terms table.

![Contract Fulfillment](/files/contract-fulfilment.png)

- **Requirement**: Enter a requirement that needs to be fulfilled. For example, 'installation'.
